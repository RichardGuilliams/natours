...
var stripe = Stripe("pk_test_51Mf95ZJsuRjOQrlgDzKkyLdUz43Dhw2p9AqNDykhc5vaqDykH1TkPMNrPe4RjKotJhbpcGZONDolYpnUQKqzcRIT00iZGLmpgP");
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        ...
        case 3:
          ...
          console.log(session); //`/chekout-session/:tourId`
...
var bookBtn = document.getElementById('book-tour'); // DELEGATE EVENTS
...
if (signupForm) {
  signupForm.addEventListener('submit', function (e) {
    ...
    document.getElementById('signup-username').value = '', _readOnlyError("name");
