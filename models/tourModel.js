...
const tourSchema = new mongoose.Schema(
    {
        ...
        priceDiscount: {
            ...
            validate:{
                ...
                message: 'A discount price {VALUE} must be less than the original price'
        ...
        maxGroupSize: {
            type: Number,
            required: [true, 'A tour needs to have a group size']
        },
        difficulty: {
            type: String,
            required: [true, 'A tour needs to have a difficulty'],
            enum: {
                values:['easy', 'medium', 'difficult'],
                message: 'Tours can only have a difficulty of easy, medium and difficult'
            },
...
// Embedding the tour guides into the tour dataModel
